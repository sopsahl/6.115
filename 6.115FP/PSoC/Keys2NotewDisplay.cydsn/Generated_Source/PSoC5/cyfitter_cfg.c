...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480008B0u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480008B8u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480008C0u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480008D0u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480008D8u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480008E0u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT5_AG, 0x40u);
...
uint8 CYXDATA * const CYCODE ADC_VolumePedal_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_VolumePedal_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_VolumePedal_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_VolumePedal_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_VolumePedal_AMux__addrTable[channel] |= ADC_VolumePedal_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_VolumePedal_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_VolumePedal_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_VolumePedal_AMux__addrTable[channel] &= (uint8)~ADC_VolumePedal_AMux__maskTable[channel];
	}
}
