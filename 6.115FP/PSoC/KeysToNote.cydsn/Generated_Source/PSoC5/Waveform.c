...
*
* \funcusage
*  \snippet Waveform_SUT.c usage_Waveform_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Waveform_SUT.c usage_Waveform_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Waveform_SUT.c usage_Waveform_Read  
*******************************************************************************/
...
* preferred Waveform_Read() API because the 
* Waveform_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Waveform_SUT.c usage_Waveform_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Waveform_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Waveform_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Waveform_0_INTR       (First pin in the list)
    *  - Waveform_1_INTR       (Second pin in the list)
    *  - ...
    *  - Waveform_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Waveform_SUT.c usage_Waveform_SetInterruptMode
    *******************************************************************************/
    void Waveform_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Waveform_0_INTR) != 0u) 
		{ 
			 Waveform_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Waveform_SUT.c usage_Waveform_ClearInterrupt
    *******************************************************************************/
