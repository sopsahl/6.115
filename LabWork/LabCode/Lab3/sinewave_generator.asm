; this code sends a sinusoidal input through to the DAC, which leads to a sinusoidal analog outputwhen fed through the circuit
main:
	mov R0, #00h
	mov dptr, #0fe00h ; location of the DAC mmio
	loop:
		lcall send_next
		movx @dptr, a 
		sjmp loop
...
send_next:
	...
	push dpl
	push dph
	mov dptr, #100h ; loction of the lookup table
